...
5. **Report**: Create a comprehensive final report in **proper Markdown format** (use `##` headers, `| table |` syntax, `**bold**`, bullet lists). Save it as `research_report.md`. Do NOT use ASCII art borders or `====` separators. Use PHASE_COMPLETE to summarize your findings for the user.
